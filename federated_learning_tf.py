...
# this_dir = Path.cwd()
# model_dir = 'D:\\UW\\RA\\Intrusion_Detection\\model\\' # this_dir / "saved_models" / experiment_name / method
...
total_x_train_count = len(x_train)
x_train_per_set = int(np.floor(total_x_train_count/split))

client_train_dataset = collections.OrderedDict()
for i in range(1, split+1):
    client_name = "client_" + str(i)
    start = x_train_per_set * (i-1)
    end = x_train_per_set * i
...
SHUFFLE_BUFFER = x_train_per_set
